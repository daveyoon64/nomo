...
describe('Scope', function() {
  ...
  describe('$evalAsync', function() {
    ...
    it('executes $evalAsynced functions added by watch functions', function() {
      // this is bad practice, since we want our watchers to be idempotent
      // however, since it's possible, we need to prevent catastrophes
      scope.aValue = [3, 4, 5];
      scope.asyncEvaluated = false;
  ...
  describe('$watchCollection', function() {
    ...
    it('notices on item replaced in an arguments object', function() {
      (function() {
    ...
    it('does no fail on NaN attricutes in objects', function() {
      scope.counter = 0;
      scope.obj = {a: NaN};
